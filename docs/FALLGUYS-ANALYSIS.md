...
**Update, same day:** all ten rows now pass. The audit above is kept as written because it is the
argument for the changes, not a scoreboard.

---

## Part 3 — The plan, in priority order

**Status: all seven shipped on 2026-09-01.** Ordered by fun-per-hour against the Sep 4 deadline.
Each item names the principle it closes.
